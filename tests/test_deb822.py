...
"""
        self.assertEqual(reformat_deb822(text_with_comment), text_with_comment)
...
class DumpParagraphsTests(TestCase):
    def test_simple(self):
        self.assertEqual(
            dump_paragraphs([Deb822({"Source": "blah", "Testsuite": "autopkgtest"})]),
            b"""\
Source: blah
Testsuite: autopkgtest
""",
    ...
    def test_multi(self):
        self.assertEqual(
            dump_paragraphs(
                [
                    Deb822({"Source": "blah", "Testsuite": "autopkgtest"}),
                    Deb822({"Package": "bloe"}),
                ]
            ),
            b"""\
